...
*IP-02 — Jetson Agent Foundation. Status: Draft, awaiting full approval. T-31 (project scaffolding and tooling) and T-32 (configuration model and settings loading) have been delivered under explicit task-level approval; T-33–T-41 have not been started. Open items OI-1–OI-4 remain open.*
